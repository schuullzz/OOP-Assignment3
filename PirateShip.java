...
public class PirateShip extends AbstractClassSpaceShip implements canMove
{
    //contains both the amount of booty and the type of ship.
    
    protected int booty;
    protected String typeName = "Pirate Ship";
    
    //Constructor that accepts name of ship, year built, x and y coordinates,
    //and the amount of booty. This constructor first calls super class 
    //super class.
    
    public PirateShip(String name, int built, int x, int y, int booty,
             int type)
    {
